...
class PersonaAccionistas implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = null;
    
    protected static $RCCPMModelName = 'PersonaAccionistas';
    ...
    protected static $RCCPMTypes = [
        ...
        'domicilio' => '\RCCPM\Simulacion\MX\Client\Model\PersonaAccionistasDomicilio',
        'porcentaje' => 'int'
    ];
    ...
    public function setRfc($rfc)
    {
        if (!is_null($rfc) && (mb_strlen($rfc) > 13)) {
            throw new \InvalidArgumentException('invalid length for $rfc when calling PersonaAccionistas., must be smaller than or equal to 13.');
        }
        if (!is_null($rfc) && (mb_strlen($rfc) < 10)) {
            throw new \InvalidArgumentException('invalid length for $rfc when calling PersonaAccionistas., must be bigger than or equal to 10.');
        }
    ...
    public function setCurp($curp)
    {
        if (!is_null($curp) && (mb_strlen($curp) > 18)) {
            throw new \InvalidArgumentException('invalid length for $curp when calling PersonaAccionistas., must be smaller than or equal to 18.');
        }
        if (!is_null($curp) && (mb_strlen($curp) < 18)) {
            throw new \InvalidArgumentException('invalid length for $curp when calling PersonaAccionistas., must be bigger than or equal to 18.');
        }
    ...
    public function setNombre($nombre)
    {
        if (!is_null($nombre) && (mb_strlen($nombre) > 75)) {
            throw new \InvalidArgumentException('invalid length for $nombre when calling PersonaAccionistas., must be smaller than or equal to 75.');
        }
        if (!is_null($nombre) && (mb_strlen($nombre) < 2)) {
            throw new \InvalidArgumentException('invalid length for $nombre when calling PersonaAccionistas., must be bigger than or equal to 2.');
        }
    ...
    public function setSegundoNombre($segundo_nombre)
    {
        if (!is_null($segundo_nombre) && (mb_strlen($segundo_nombre) > 75)) {
            throw new \InvalidArgumentException('invalid length for $segundo_nombre when calling PersonaAccionistas., must be smaller than or equal to 75.');
        }
        if (!is_null($segundo_nombre) && (mb_strlen($segundo_nombre) < 2)) {
            throw new \InvalidArgumentException('invalid length for $segundo_nombre when calling PersonaAccionistas., must be bigger than or equal to 2.');
        }
    ...
    public function setApellidoPaterno($apellido_paterno)
    {
        if (!is_null($apellido_paterno) && (mb_strlen($apellido_paterno) > 25)) {
            throw new \InvalidArgumentException('invalid length for $apellido_paterno when calling PersonaAccionistas., must be smaller than or equal to 25.');
        }
        if (!is_null($apellido_paterno) && (mb_strlen($apellido_paterno) < 2)) {
            throw new \InvalidArgumentException('invalid length for $apellido_paterno when calling PersonaAccionistas., must be bigger than or equal to 2.');
        }
    ...
    public function setApellidoMaterno($apellido_materno)
    {
        if (!is_null($apellido_materno) && (mb_strlen($apellido_materno) > 25)) {
            throw new \InvalidArgumentException('invalid length for $apellido_materno when calling PersonaAccionistas., must be smaller than or equal to 25.');
        }
        if (!is_null($apellido_materno) && (mb_strlen($apellido_materno) < 2)) {
            throw new \InvalidArgumentException('invalid length for $apellido_materno when calling PersonaAccionistas., must be bigger than or equal to 2.');
        }
